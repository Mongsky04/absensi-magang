...
export const createUserAdmin = async (req, res) => {
  try {
    const { nama, email, password, role, perusahaan, jabatan, kampus, isMentor, mentorId, mentor, tanggalMulai, tanggalSelesai } = req.body;
...
export const updateUserAdmin = async (req, res) => {
  try {
    const { id } = req.params;
    const { nama, email, password, role, perusahaan, jabatan, kampus, isMentor, mentorId, mentor, foto, tanggalMulai, tanggalSelesai } = req.body;
    ...
    if (tanggalMulai !== undefined) user.tanggalMulai = tanggalMulai || null;
    if (tanggalSelesai !== undefined) user.tanggalSelesai = tanggalSelesai || null;
