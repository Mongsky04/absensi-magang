...
export default function Admin() {
  ...
  const startEdit = (u) => {
    ...
    setForm({
      ...
      tanggalMulai: u.tanggalMulai ? new Date(u.tanggalMulai).toISOString().split('T')[0] : "",
      tanggalSelesai: u.tanggalSelesai ? new Date(u.tanggalSelesai).toISOString().split('T')[0] : "",
    });
    setShowForm(true);
  };
